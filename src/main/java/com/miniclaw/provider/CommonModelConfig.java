 ...
 * @see AgentConfig
 */
public class CommonModelConfig implements ModelConfig {
    ...
    private CommonModelConfig(Builder builder) {
    ...
    public Model createModel() {
        ...
        if (modelClass == AnthropicChatModel.class) {
    ...
    public boolean equals(Object o) {
        ...
        CommonModelConfig that = (CommonModelConfig) o;
    ...
    public static class Builder {
        ...
        public Builder modelClass(Class<? extends Model> modelClass) {
         ...
         */
        public CommonModelConfig build() {
            return new CommonModelConfig(this);
        }
    }
}
