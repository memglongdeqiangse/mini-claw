...
/**
 * Registry for {@link io.agentscope.extensions.scheduler.quartz.QuartzAgentScheduler} instances.
 *
 ...
 */
public class QuartzAgentSchedulerRegistry {
     ...
     */
    public static QuartzAgentScheduler get(String id) {
