...
import io.agentscope.extensions.scheduler.config.*;
import org.quartz.*;
...
public class QuartzAgentScheduler implements AgentScheduler {
    ...
    public ScheduleAgentTask schedule(AgentConfig agentConfig, ScheduleConfig scheduleConfig, String input) {
        if (agentConfig == null) {
        ...
        if (input != null){
            jobDetail.getJobDataMap().put("inputMsg", input);
        }
            ...
            if (mode == ScheduleMode.CRON) {
                ...
                Trigger trigger =
                        TriggerBuilder.newTrigger()
                                ...
                                .usingJobData("taskContent", input)
                                .startAt(startAt)
                                .withSchedule(csb)
                                .build();
